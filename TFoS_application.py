...
if __name__ == '__main__':
  ...
  sc = SparkContext(conf=SparkConf().setAppName("TFoS_application"))
  ...
  images_labels = sc.textFile(args.images_labels, 100).map(parse)
  print("Num Partitions:\t", images_labels.getNumPartitions())
